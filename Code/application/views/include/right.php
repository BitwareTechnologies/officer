            ...
            <div class="offcanvas-content">
                ...
                <div class="content slimscroll">
                    ...
                    <div class="panel nm">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="media">
                                ...
                                <!--/ indicator -->
                                <img data-toggle="unveil" src="<?php echo base_url(); ?>/assets/image/placeholder.jpg" data-src="<?php echo base_url(); ?>/assets/image/background3.jpg" alt="Cover" width="100%">
                            </div>
                            <!--/ media -->
                        </div>
                        <!--/ thumbnail -->
                    ...
                    <div class="panel-body text-center" style="margin-top:-55px;z-index:11">
                        <img class="img-circle mb5" src="<?php echo base_url(); ?>/assets/image/avatar/avatar7.jpg" alt="" width="75">
                    ...
                    <div class="media-list media-list-contact">
                        ...
                        <a href="javascript:void(0);" class="media offcanvas-opener offcanvas-open-rtl">
                            <span class="media-object pull-left">
                                <img src="<?php echo base_url(); ?>/assets/image/avatar/avatar1.jpg" class="img-circle" alt="">
                            </span>
                        ...
                        <a href="javascript:void(0);" class="media offcanvas-opener offcanvas-open-rtl">
                            <span class="media-object pull-left">
                                <img src="<?php echo base_url(); ?>/assets/image/avatar/avatar2.jpg" class="img-circle" alt="">
                            </span>
                            <span class="media-body">
                        ...
                        <a href="javascript:void(0);" class="media offcanvas-opener offcanvas-open-rtl">
                            <span class="media-object pull-left">
                                <img src="<?php echo base_url(); ?>/assets/image/avatar/avatar.png" class="img-circle" alt="">
                            </span>
                            <span class="media-body">
                        ...
                        <a href="javascript:void(0);" class="media offcanvas-opener offcanvas-open-rtl">
                            <span class="media-object pull-left">
                                <img src="<?php echo base_url(); ?>/assets/image/avatar/avatar3.jpg" class="img-circle" alt="">
                            </span>
                            <span class="media-body">
                        ...
                        <a href="javascript:void(0);" class="media offcanvas-opener offcanvas-open-rtl">
                            <span class="media-object pull-left">
                                <img src="<?php echo base_url(); ?>/assets/image/avatar/avatar4.jpg" class="img-circle" alt="">
                            </span>
                            <span class="media-body">
                        ...
                        <a href="javascript:void(0);" class="media offcanvas-opener offcanvas-open-rtl">
                            <span class="media-object pull-left">
                                <img src="<?php echo base_url(); ?>/assets/image/avatar/avatar5.jpg" class="img-circle" alt="">
                            </span>
                            <span class="media-body">
                        ...
                        <a href="javascript:void(0);" class="media offcanvas-opener offcanvas-open-rtl">
                            <span class="media-object pull-left">
                                <img src="<?php echo base_url(); ?>/assets/image/avatar/avatar6.jpg" class="img-circle" alt="">
                            </span>
                            <span class="media-body">
                        ...
                        <a href="javascript:void(0);" class="media offcanvas-opener offcanvas-open-rtl">
                            <span class="media-object pull-left">
                                <img src="<?php echo base_url(); ?>/assets/image/avatar/avatar8.jpg" class="img-circle" alt="">
                            </span>
                            <span class="media-body">
                        ...
                        <a href="javascript:void(0);" class="media offcanvas-opener offcanvas-open-rtl">
                            <span class="media-object pull-left">
                                <img src="<?php echo base_url(); ?>/assets/image/avatar/avatar9.jpg" class="img-circle" alt="">
                            </span>
                            <span class="media-body">
                    ...
                    <ul class="media-list media-list-bubble">
                        <li class="media media-right">
                            <a href="javascript:void(0);" class="media-object">
                                <img src="<?php echo base_url(); ?>/assets/image/avatar/avatar7.jpg" class="img-circle" alt="">
                            </a>
