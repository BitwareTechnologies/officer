            ...
            <div class="col-lg-12 col-md-12 col-sm-4 col-xs-12">
                ...
                <div class="widget-wrapper bg-theme rounded">
                    <div class="weather-current-city">
                        <img src="<?php echo base_url('img/media/building/5.jpg'); ?>" alt="..."/>
                        <div class="row">
...
<div class="col-md-9">
    ...
    <div class="table-responsive rounded mb-20">
        <table class="table table-striped table-theme">
            ...
            <tr>
                ...
                <td>
                    <img src="<?php echo base_url('img/avatar/35/2.png'); ?>" class="img-circle img-bordered-theme" alt="John Kribo">
            ...
            <tr>
                ...
                <td>
                    <img src="<?php echo base_url('img/avatar/35/3.png'); ?>" class="img-circle img-bordered-theme" alt="Jennifer Poiyem">
            ...
            <tr>
                ...
                <td>
                    <img src="<?php echo base_url('img/avatar/35/4.png'); ?>" class="img-circle img-bordered-theme" alt="Clara Wati">
            ...
            <tr>
                ...
                <td>
                    <img src="<?php echo base_url('img/avatar/35/5.png'); ?>" class="img-circle img-bordered-theme" alt="Toni Mriang">
            ...
            <tr>
                ...
                <td>
                    <img src="<?php echo base_url('img/avatar/35/6.png'); ?>" class="img-circle img-bordered-theme" alt="Bella negoro">
    ...
    <!-- Start dropzone js -->
    <form action="<?php echo base_url('assets/admin/data'); ?>" class="dropzone mb-20 rounded">
        <div class="fallback">
